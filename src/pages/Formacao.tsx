...
const Formacao = () => {
  ...
  const services = [
    ...
    {
      icon: Globe,
      title: 'Palestras e Formação Internacional',
      subtitle: 'Presença Global',
      description: 'Participação em eventos científicos e clínicos internacionais para disseminação do Método RNS, consolidação de autoridade intelectual e criação de rede de profissionais.',
      features: [
            ...
            {targetAudience.map((audience, index) => (
              <div key={index} className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-premium">{audience.description}</p>
                </div>
              </div>
            ))}
          </div>
